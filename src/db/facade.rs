...
impl DbFacade {
    ...
    pub async fn register_student(&self, telegram_id: i64, faculty: &str, group: &str) -> anyhow::Result<Student> {
        students_repo::insert(&self.pool, telegram_id, faculty, group).await
    }
}
